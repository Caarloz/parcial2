...
class detalleSilla2 extends StatefulWidget {
  final dynamic producto;
  final dynamic i;

  const detalleSilla2({Key? key, this.producto, this.i}) : super(key: key);

  @override
  State<detalleSilla2> createState() => _detalleSilla2State();
}
...
class _detalleSilla2State extends State<detalleSilla2> {
  @override
  int _cIndex = -1;
  ...
  @override
  void initState() {
    lista.add(new Animal(sillas2[0]['img']));
    lista.add(new Animal(sillas2[1]['img']));
    lista.add(new Animal(sillas2[2]['img']));
